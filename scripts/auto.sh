...
# run kilocode --auto to commit and push changes
kilocode --auto 'Check this folder for Git changes, create a message via git-diff, stage, commit and push everything to the GitHub repo.'
echo "Auto script executed."